  ...
  return (
    <div className="relative bg-cyan-800 bg-[url('/assets/banner-image.webp')] bg-no-repeat bg-cover box-border flex flex-col max-w-full break-words w-full bg-[position:left_50%] mx-auto px-5 before:accent-auto before:bg-[linear-gradient(rgba(0,25,44,0)_-3%,rgb(0,25,44)_133.75%)] before:box-border before:text-neutral-600 dark:text-neutral-400 before:block before:text-base before:not-italic before:normal-nums before:font-normal before:h-[max(100%_+_0px,100%)] before:tracking-[normal] before:leading-7 before:list-outside before:list-disc before:break-words before:pointer-events-auto before:absolute before:text-start before:no-underline before:indent-[0px] before:normal-case before:visible before:w-[max(100%_+_0px,100%)] before:border-separate before:left-0 before:top-0 before:font-inter">
      <div className="items-start box-border gap-x-5 flex flex-col grow flex-wrap h-full justify-center max-w-[min(100%,767px)] min-h-[auto] min-w-[auto] break-words gap-y-5 w-full mx-auto pt-[75px] pb-20 md:flex-nowrap md:max-w-[1620px] md:pt-[110px] md:pb-[115px]">
        <div className="relative box-border gap-x-5 max-w-full min-h-[auto] break-words gap-y-5">
          <div className="relative text-white items-center box-border gap-x-2 flex flex-wrap justify-start break-words gap-y-2 md:justify-center">
            <span className="box-border block min-h-[auto] min-w-[auto] break-words">
              <Link title="Go to Home." to="/" className="box-border inline-block break-words">
            ...
            <span className="relative items-center box-border flex leading-4 min-h-[auto] min-w-[auto] break-words">
              <img src="/assets/icon-42.svg" alt="Icon" className="relative box-border h-4 align-baseline w-4" />
            </span>
            <span className="box-border block min-h-[auto] min-w-[auto] break-words">
              <span className="box-border inline-block break-words">About us</span>
            </span>
          </div>
        </div>
        <div className="relative box-border gap-x-5 max-w-full min-h-[auto] break-words gap-y-5">
          <h1 className="text-white text-4xl font-medium box-border leading-[43.2px] break-words font-bitter md:text-[56px] md:leading-[66px]">About Lohia College</h1>
        </div>
        <div className="relative box-border gap-x-5 h-px max-w-full min-h-[auto] break-words gap-y-5 w-[480px]">
          <div className="relative items-center bg-white dark:bg-slate-900/20 box-border flex h-full justify-center break-words w-full before:accent-auto before:bg-white dark:bg-slate-900 before:box-border before:text-neutral-600 dark:text-neutral-400 before:block before:text-base before:not-italic before:normal-nums before:font-normal before:h-0.5 before:tracking-[normal] before:leading-7 before:list-outside before:list-disc before:break-words before:pointer-events-auto before:absolute before:text-start before:no-underline before:indent-[0px] before:normal-case before:-translate-y-px before:visible before:w-[145px] before:border-separate before:left-0 before:top-2/4 before:font-inter after:accent-auto after:bg-white dark:bg-slate-900 after:box-border after:text-neutral-600 dark:text-neutral-400 after:hidden after:text-base after:not-italic after:normal-nums after:font-normal after:h-0 after:tracking-[normal] after:leading-7 after:list-outside after:list-disc after:break-words after:pointer-events-auto after:absolute after:text-start after:no-underline after:indent-[0px] after:normal-case after:visible after:w-0 after:border-separate after:right-0 after:top-2/4 after:font-inter">
        ...
        <div className="absolute box-border gap-x-5 hidden max-w-full break-words gap-y-5 transform-none z-[1] right-5 bottom-5 md:block md:translate-y-[1.1125px] md:right-[140px] md:bottom-[60px]">
          <div className="relative box-border h-full break-words text-left w-full">
            <img src="/assets/hero-arrow.webp" alt="bnr-arrow-1-1" className="relative box-border inline max-w-full break-words z-[1]" />
          </div>
        </div>
      </div>
    </div>
