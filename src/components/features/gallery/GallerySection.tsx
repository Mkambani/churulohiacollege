    ...
    <div className="relative box-border gap-x-0 flex flex-wrap max-w-full break-words gap-y-0 w-full overflow-hidden mx-auto md:flex-nowrap">
      <div className="relative box-border gap-x-0 max-w-full min-h-[auto] break-words gap-y-0 w-6/12 md:w-auto">
        <div className="relative box-border h-full break-words text-left w-full">
          <img alt="gallery-img1-min" className="relative box-border inline max-w-full break-words z-[1]" src="/assets/gallery-img1-min.jpg" />
        </div>
      </div>
      <div className="relative box-border gap-x-0 max-w-full min-h-[auto] break-words gap-y-0 w-6/12 md:w-auto">
        <div className="relative box-border h-full break-words text-left w-full">
          <img alt="gallery-img2-min" className="relative box-border inline max-w-full break-words z-[1]" src="/assets/gallery-img2-min.jpg" />
        </div>
      </div>
      <div className="relative box-border gap-x-0 max-w-full min-h-[auto] break-words gap-y-0 w-6/12 md:w-auto">
        <div className="relative box-border h-full break-words text-left w-full">
          <img alt="gallery-img3-min" className="relative box-border inline max-w-full break-words z-[1]" src="/assets/gallery-img3-min.jpg" />
        </div>
      </div>
      <div className="relative box-border gap-x-0 max-w-full min-h-[auto] break-words gap-y-0 w-6/12 md:w-auto">
        <div className="relative box-border h-full break-words text-left w-full">
          <img alt="gallery-img4-min" className="relative box-border inline max-w-full break-words z-[1]" src="/assets/gallery-img4-min.jpg" />
        </div>
      </div>
      <div className="relative box-border gap-x-0 max-w-full min-h-[auto] break-words gap-y-0 w-6/12 md:w-auto">
        <div className="relative box-border h-full break-words text-left w-full">
          <img alt="gallery-img5-5-min" className="relative box-border inline max-w-full break-words z-[1]" src="/assets/gallery-img5-5-min.jpg" />
        </div>
      </div>
      <div className="relative box-border gap-x-0 max-w-full min-h-[auto] break-words gap-y-0 w-6/12 md:w-auto">
        <div className="relative box-border h-full break-words text-left w-full">
          <img alt="gallery-img6-min" className="relative box-border inline max-w-full break-words z-[1]" src="/assets/gallery-img6-min.jpg" />
        </div>
      </div>
      <div className="absolute self-center box-border gap-x-0 max-w-full break-words gap-y-0 text-center w-full z-[1] left-2/4 top-2/4 md:text-start md:w-auto">
        <Link to="/about" className="relative text-white text-[15px] font-medium items-center bg-sky-500 box-border gap-x-[15px] inline-flex flex-row-reverse justify-center leading-[18px] break-words gap-y-[15px] text-center uppercase z-[1] overflow-hidden px-[26px] py-4 rounded-[30px] md:text-start">
          <span className="relative items-center box-border flex justify-center min-h-[auto] min-w-[auto] break-words text-center md:text-start">
            <img alt="Icon" className="relative box-border h-[15px] text-center align-baseline w-[15px] md:text-start" src="/assets/donate-button-right-icon.svg" />
          </span>
